...
SECRET_KEY = 'django-insecure-ou&-bh$)fiz^u!)(+_=#cdprl@n54^+9)w8mj0g+oagkf_3@+a'
...
USE_TZ = True  # This is required to handle timezone-aware datetimes
...
STATICFILES_DIRS = [
    BASE_DIR / 'static'  # Ensure the "static" directory exists in your project root
]
